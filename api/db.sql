...
(8, 2, 'Основы Python: переменные и типы', '<h2>Динамическая типизация</h2><p>В Python имя ссылается на объект; тип определяется значением. Базовые типы: <code>int</code>, <code>float</code>, <code>str</code>, <code>bool</code>.</p><pre>x = 10<br>name = \"student\"<br>pi = 3.14</pre><h3>Ввод-вывод</h3><p><code>print()</code> выводит в консоль; <code>input()</code> читает строку. Для чисел используют <code>int()</code> или <code>float()</code>.</p><p>Среда проверки заданий в приложении запускает решения на языке выбранного курса (C++, Python, C#, Go). Следите за форматом вывода: перевод строки и пробелы должны совпадать с ожидаемым результатом.</p>'),
...
(4, 4, '<b>Задание</b><br>Напишите программу на <b>C#</b>: считайте одно целое число и выведите его квадрат (целое) с переводом строки.</p>'),
(5, 5, '<b>Задание</b><br>На <b>C#</b>: считайте одно целое <code>a</code> и выведите <code>3*a</code> с переводом строки.</p>'),
(6, 6, '<b>Задание</b><br>Напишите программу на <b>Go</b>: считайте два целых числа <code>x</code> и <code>y</code> и выведите модуль их разности (неотрицательное значение |x-y|) как целое с переводом строки.</p>'),
(7, 7, '<b>Задание</b><br>На <b>Go</b>: считайте два натуральных числа <code>a</code> и <code>b</code> и выведите их наибольший общий делитель с переводом строки.</p>'),
(8, 8, '<b>Задание</b><br>Напишите программу на <b>Python</b>: считайте два неотрицательных целых a и b (b &gt; 0) и выведите результат целочисленного деления a/b без остатка и перевод строки.</p>'),
(9, 9, '<b>Задание</b><br>На <b>Python</b>: в первой строке целое <code>n</code> (1 ≤ n ≤ 45). Выведите <code>n</code>-й элемент последовательности Фибоначчи с нуля: F<sub>0</sub>=0, F<sub>1</sub>=1, каждое следующее — сумма двух предыдущих. Число выведите с переводом строки.</p>'),
(10, 10, '<b>Задание</b><br>На <b>Python</b>: первая строка — целое <code>n</code> (1 ≤ n ≤ 100). Далее <code>n</code> целых. Выведите среднее значение как целую часть (целое деление суммы на n) с переводом строки.</p>'),
...
(12, 12, '<b>Задание</b><br>На <b>Go</b>: одна строка из печатных ASCII-символов без пробела в конце. Выведите сумму кодов всех символов строки (как в Go <code>byte</code>) с переводом строки.</p>');
